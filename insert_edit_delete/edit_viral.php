...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Update the database
        $sql = $conn->prepare("UPDATE viral SET 
...
<body>
    <div class="container justify-content-center">
        <div class="card_content">
            <form class="row g-3" action="edit_viral.php?id=<?= htmlspecialchars($id, ENT_QUOTES) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="btnAction">
                        <a href="../admin.php"class="Btn_cancel_viral">ยกเลิก</a>
