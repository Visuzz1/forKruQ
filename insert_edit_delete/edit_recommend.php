...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Update the database
        $sql = $conn->prepare("UPDATE recommend SET 
        ...
        $stmt = $conn->prepare("SELECT * FROM recommend WHERE id = :id");
...
<body>
    <div class="container justify-content-center">
        <div class="card_content">
            <form class="row g-3" action="edit_recommend.php?id=<?= htmlspecialchars($id, ENT_QUOTES) ?>" method="post" enctype="multipart/form-data">
